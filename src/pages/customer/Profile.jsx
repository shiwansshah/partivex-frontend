...
function Profile() {
  ...
  return (
    <div className="customer-page portal-container">
      <section className="portal-page-hero profile-hero">
        <div>
          <span className="customer-eyebrow">Account</span>
          <h1>Personal info</h1>
          <p>Keep your service contact details current so bookings and requests stay connected to the right customer.</p>
        </div>
        <img src={customerPortalImages.support} alt="Customer service team reviewing account details" />
      </section>
      ...
      <aside className="customer-side-panel profile-side-panel">
        <img src={customerPortalImages.garage} alt="Vehicle service team preparing a garage bay" />
        <div>
          <span className="customer-eyebrow">Why update this?</span>
          <h2>Service teams use this information when they need to confirm a booking or clarify a part request.</h2>
          <p>Your email remains tied to sign-in, while your phone number can help with service coordination.</p>
        </div>
      </aside>
      </div>
    </div>
